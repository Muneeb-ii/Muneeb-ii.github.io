    ...
    <>
      ...
      <div className="relative pb-20">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-1/4 -right-1/4 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-rose-500/10 via-orange-500/5 to-transparent dark:from-rose-600/20 dark:via-orange-500/10 blur-3xl" />
        ...
        <Section className="pt-20 relative">
          ...
          <div className="max-w-none mb-16">
            ...
            <ScrollReveal direction="up" delay={0.1}>
              <div className="bg-gradient-to-br from-slate-50 via-white to-rose-50/30 dark:from-gray-900/80 dark:via-gray-900/60 dark:to-rose-950/20 rounded-lg p-8 mb-12 border border-gray-100 dark:border-gray-800/50 backdrop-blur-sm">
            ...
            <ScrollReveal direction="up" delay={0.2}>
              <div className="mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-white to-rose-50/50 dark:from-[#0A0A0A] dark:to-rose-950/10 border-l-2 border-f1-red dark:border-f1-orange p-6 rounded-r-lg shadow-sm dark:shadow-none">
                  ...
                  <div className="bg-gradient-to-br from-white to-blue-50/50 dark:from-[#0A0A0A] dark:to-blue-950/10 border-l-2 border-f1-red dark:border-f1-orange p-6 rounded-r-lg shadow-sm dark:shadow-none">
                    <h3 className="font-racing font-bold text-lg mb-2 text-gray-900 dark:text-white">
                      Proof over promises
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400">
                  ...
                  <div className="bg-gradient-to-br from-white to-amber-50/50 dark:from-[#0A0A0A] dark:to-amber-950/10 border-l-2 border-f1-red dark:border-f1-orange p-6 rounded-r-lg shadow-sm dark:shadow-none">
                    <h3 className="font-racing font-bold text-lg mb-2 text-gray-900 dark:text-white">
                      Systems thinking
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400">
                  ...
                  <div className="bg-gradient-to-br from-white to-indigo-50/50 dark:from-[#0A0A0A] dark:to-indigo-950/10 border-l-2 border-f1-red dark:border-f1-orange p-6 rounded-r-lg shadow-sm dark:shadow-none">
                    <h3 className="font-racing font-bold text-lg mb-2 text-gray-900 dark:text-white">
              ...
              <StaggerContainer staggerSpeed="fast" className="space-y-4">
                {content.achievements.map((achievement, idx) => (
                  <StaggerItem key={idx} direction="up">
                    <div className="bg-gradient-to-r from-white via-white to-slate-50 dark:from-[#0A0A0A] dark:via-[#0A0A0A] dark:to-gray-900/50 border-l-2 border-transparent hover:border-f1-red dark:hover:border-f1-orange p-5 transition-all hover:from-rose-50/50 hover:to-white dark:hover:from-rose-950/20 dark:hover:to-gray-900/50 rounded-r-lg">
